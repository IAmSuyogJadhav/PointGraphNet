...
for i in range(len(instances)):
    points, curve, normals, orth0, orth1 = instances[i]
    ...
    ax.quiver(
        ...
        normals[::step, 2],
        color="red",
        label="Cross-section normals" if i == 0 else None,
        length=500,
    )
    ax.quiver(
        curve[::step, 0],
        ...
        orth0[::step, 2],
        color="blue",
        label="Orthogonal vectors" if i == 0 else None,
        length=500,
    )
    ax.quiver(
        curve[::step, 0],
...
for i in range(len(instances)):
    ...
    ax.scatter(
        ...
        alpha=0.5,
        marker=".",
        label="Surface points" if i == 0 else None,
    )
    ax.set_xlabel("x")
    ax.set_ylabel("y")
    ax.set_zlabel("z")
    ...
    ax.quiver(
        ...
        points["nz"][::step],
        color="blue",
        label="Surface normals" if i == 0 else None,
        length=200,
        alpha=0.3,
    )
